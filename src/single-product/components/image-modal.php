...
function etheme_render_image_modal( $gallery_images ) {
	...
	<div id="image-modal"
		 ...
		 role="dialog"
		 aria-modal="true"
		 aria-label="<?php esc_attr_e( 'Product image gallery', 'etheme' ); ?>">
		...
		<div class="modal-content relative w-full h-full flex items-center justify-center p-4">
			...
			<button type="button"
					...
					data-close-modal
					aria-label="<?php esc_attr_e( 'Close gallery', 'etheme' ); ?>">
			...
			<button type="button"
					...
					id="modal-prev"
					aria-label="<?php esc_attr_e( 'Previous image', 'etheme' ); ?>">
				<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<button type="button"
					...
					id="modal-next"
					aria-label="<?php esc_attr_e( 'Next image', 'etheme' ); ?>">
				<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<div class="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 flex gap-2">
				<button type="button"
						...
						id="modal-zoom-out"
						aria-label="<?php esc_attr_e( 'Zoom out', 'etheme' ); ?>">
				...
				<button type="button"
						class="bg-white/10 hover:bg-white/20 text-white rounded-full p-2 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-white"
						id="modal-zoom-reset"
						aria-label="<?php esc_attr_e( 'Reset zoom', 'etheme' ); ?>">
					<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				...
				<button type="button"
						class="bg-white/10 hover:bg-white/20 text-white rounded-full p-2 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-white"
						id="modal-zoom-in"
						aria-label="<?php esc_attr_e( 'Zoom in', 'etheme' ); ?>">
					<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
