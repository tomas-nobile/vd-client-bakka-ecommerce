			...
			<div class="all_row grid grid-cols-1 md:grid-cols-3 gap-6" data-aos="fade-up">
				...
				<div class="all_column">
					<div class="contact-box all_boxes">
						<figure class="icon">
							<img src="<?php echo $icon_base; ?>contactinfo-icon1.webp" alt="<?php esc_attr_e( 'Icono de ubicación', 'etheme' ); ?>" class="img-fluid">
						</figure>
				...
				<div class="all_column">
					<div class="contact-box all_boxes">
						<figure class="icon">
							<img src="<?php echo $icon_base; ?>contactinfo-icon2.webp" alt="<?php esc_attr_e( 'Icono de teléfono', 'etheme' ); ?>" class="img-fluid">
						</figure>
				...
				<div class="all_column">
					<div class="contact-box all_boxes">
						<figure class="icon">
							<img src="<?php echo $icon_base; ?>contactinfo-icon3.webp" alt="<?php esc_attr_e( 'Icono de email', 'etheme' ); ?>" class="img-fluid">
						</figure>
