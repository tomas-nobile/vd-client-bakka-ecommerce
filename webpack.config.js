...
module.exports = {
	...
	entry: {
		...
		'page-trabajos-realizados/index/index': path.resolve(process.cwd(), 'src/page-trabajos-realizados/index', 'index.js'),
		'page-trabajos-realizados/index/view': path.resolve(process.cwd(), 'src/page-trabajos-realizados/index', 'view.js'),
