<?php
/**
 * Customer on-hold order email (C4) — plain text.
 *
...
esc_html_e( 'Tu pedido está en espera hasta que confirmemos que el pago fue procesado. Te avisaremos por email cuando esté listo.', 'etheme' );
echo "\n\n";

esc_html_e( 'Acá te recordamos lo que pediste:', 'etheme' );
echo "\n\n";
...
if ( $etheme_contact_mail ) {
	echo "\n";
	printf(
		esc_html__( 'Si tenés dudas, escribinos a %s.', 'etheme' ),
